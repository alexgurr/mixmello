		...
		<div className="footer">
			...
			<div className="footer__content">
				<div style={{ display: 'flex', justifyContent: 'space-between' }}>
					...
					<div className="footer__content__list" >
						<a href="https://www.twitter.com/alexgurr" target="_blank" rel="noreferrer"><Icon colour="white" name="faTwitter" /></a>
						<a href="https://www.github.com/alexgurr" target="_blank" rel="noreferrer"><Icon colour="white" name="faGithub" /></a>
						<a href="https://www.alexgurr.com" target="_blank" rel="noreferrer"><Icon colour="white" name="faCloud" /></a>
					</div>
				</div>
